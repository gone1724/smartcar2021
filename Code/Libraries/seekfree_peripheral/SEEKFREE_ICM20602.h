...
//PERIPHERAL_PIN_SWITCH的值可以在board.h文件中修改
	...
	//--------------------硬件SPI--------------------
	#define ICM20602_SPI_N 			SPI_CH2		
	#define ICM20602_SPI_SCLK_PIN   P25
	#define ICM20602_SPI_MOSI_PIN   P23
	#define ICM20602_SPI_MISO_PIN   P24
	#define ICM20602_SPI_CS_PIN     P22
